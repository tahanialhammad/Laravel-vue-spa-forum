<template>
  <div>
    <div v-if="$page.props.flash.message && show" class="flex items-center justify-between mb-8 max-w-3xl bg-blue-500 rounded">
      <div class="flex items-center">
        ...
        <div class="py-4 text-white text-sm font-medium">{{ $page.props.flash.message }}</div>
      </div>
