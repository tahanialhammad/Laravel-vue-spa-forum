...
watchEffect(async () => {
    ...
    show.value = true;
// Set a wait timeout to disappear after 5 minutes, then clear it.
...
<template>
    <div class="sticky top-0 z-40">
        <div v-if="show && message" :class="{ 'bg-green-500': style == 'success', 'bg-green-700': style == 'danger' }">
            <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between flex-wrap">
                    <div class="w-0 flex-1 flex items-center min-w-0">
                        <span class="flex p-2 rounded-lg" :class="{ 'bg-green-600': style == 'success', 'bg-rose-600': style == 'danger' }">
                    ...
                    <div class="shrink-0 sm:ml-3">
                        <button
                            ...
                            :class="{ 'hover:bg-green-600 focus:bg-green-600': style == 'success', 'hover:bg-rose-600 focus:bg-rose-600': style == 'danger' }"
                            aria-label="Dismiss"
