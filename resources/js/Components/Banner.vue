...
watchEffect(async () => {
    ...
    show.value = true;
// setTimeout to be disabeer after 5 min, and then clear timeout
    clearTimeout(timeout.value);
    timeout.value = setTimeout(() => show.value = false, 5000);
});
//and then clear timeout
onUnmounted(() => clearTimeout(timeout.value));
</script>

<template>
    <div class="sticky top-0 z-40">
        <div v-if="show && message" :class="{ 'bg-rose-500': style == 'success', 'bg-rose-700': style == 'danger' }">
                ...
                <div class="flex items-center justify-between flex-wrap">
                    ...
                    <div class="shrink-0 sm:ml-3">
                        <button
                            ...
                            :class="{ 'hover:bg-rose-600 focus:bg-rose-600': style == 'success', 'hover:bg-red-600 focus:bg-red-600': style == 'danger' }"
                            aria-label="Dismiss"
